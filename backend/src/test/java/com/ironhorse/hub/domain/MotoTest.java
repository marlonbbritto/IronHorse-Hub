...
class MotoTest {
    ...
    void shouldCreateAMotoCorrectly() {
        Moto moto = new Moto(1L, "Fat Boy", 2023, 1500.0, "ABC-1234", "VIN123456789");
    ...
    void shouldThrowExceptionWhenModeloIsBlank() {
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            new Moto(1L, "", 2023, 1500.0, null, null);
        });
    ...
    void shouldThrowExceptionWhenAnoIsInvalid() {
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            new Moto(1L, "Softail", 1899, 0.0, null, null);
        });
    ...
    void shouldThrowExceptionWhenKmIsNegative() {
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            new Moto(1L, "Street Glide", 2024, -1.0, null, null);
        });
